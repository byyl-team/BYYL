...
%type <newfather> Program ExtDefList ExtDef ExtDecList ExpDef_miss_SEMI Specifier StructSpecifier StructSpecifier_miss_RC OptTag Tag VarDec VarDec_miss_RB FunDec FunDec_miss_RP VarList ParamDec CompSt CompSt_miss_RC StmtList Stmt Stmt_miss_SEMI DefList Def Def_miss_SEMI DecList Dec Exp  Args
%right ASSIGNOP
%left AND OR
%left RELOP
%left PLUS MINUS
...
|ExpDef_miss_SEMI{$$=gramTree("ExtDef",1,$1);}
;
ExpDef_miss_SEMI : Specifier ExtDecList {$$=gramTree("ExpDef_miss_SEMI",2,$1,$2);printf("missing SEMI at %d\n",$2->lineno);}
|Specifier {$$=gramTree("ExpDef_miss_SEMI",1,$1);printf("missing SEMI at %d\n",$1->lineno);}
;
...
| error RC {printf("error at line: %d\n",$2->lineno);$$=gramTree("StructSpecifier",1,$2);}
| STRUCT Tag{$$=gramTree("StructSpecifier",2,$1,$2);}
| StructSpecifier_miss_RC {$$=gramTree("StructSpecifier",1,$1);}
;
StructSpecifier_miss_RC : STRUCT OptTag LC DefList {$$=gramTree("StructSpecifier_miss_RC",4,$1,$2,$3,$4);printf("missing RC at %d\n",$4->lineno);}
;
...
| error RB{printf("error at line: %d\n",$2->lineno);$$=gramTree("VarDec",1,$2);}
| VarDec_miss_RB {$$=gramTree("VarDec",1,$1);}
;
VarDec_miss_RB : VarDec LB INT {$$=gramTree("VarDec_miss_RB",3,$1,$2,$3);printf("missing RB at %d\n",$3->lineno);}
;
FunDec : ID LP VarList RP{$$=gramTree("FunDec",4,$1,$2,$3,$4);}
| ID LP RP{$$=gramTree("FunDec",3,$1,$2,$3);}
| error RP{printf("error at line: %d\n",$2->lineno);$$=gramTree("FunDec",1,$2);}
| FunDec_miss_RP {$$=gramTree("FunDec",1,$1);}
;
FunDec_miss_RP : ID LP VarList {$$=gramTree("FunDec_miss_RP",3,$1,$2,$3);printf("missing RP at %d\n",$3->lineno);}
| ID LP {$$=gramTree("FunDec_miss_RP",2,$1,$2);printf("missing RP at %d\n",$2->lineno);}
;
...
| CompSt_miss_RC {$$=gramTree("Compst",1,$1);}
;
CompSt_miss_RC : LC DefList StmtList  {$$=gramTree("Compst_miss_RC",3,$1,$2,$3);printf("missing RC at %d\n",$3->lineno);}
;
...
| error SEMI {printf("error at line: %d\n",$2->lineno);$$=gramTree("Stmt",1,$2);}
...
| Stmt_miss_SEMI {$$=gramTree("Stmt",1,$1);}
;
Stmt_miss_SEMI : Exp {$$=gramTree("Stmt_miss_SEMI",1,$1);printf("missing SEMI at %d\n",$1->lineno);}//优先级！！！！
|RETURN Exp {$$=gramTree("Stmt_miss_SEMI",2,$1,$2);printf("missing SEMI at %d\n",$2->lineno);}
;
...
| Def_miss_SEMI {$$=gramTree("Def",1,$1);}
;
Def_miss_SEMI : Specifier DecList {$$=gramTree("Def_miss_SEMI",2,$1,$2);printf("missing SEMI at %d\n",$2->lineno);}
;
